      ...
      <div className="bg-dark">
        <div className="container-fluid ">
          <div className="flex flex-col md:flex-row text-white pb-5 pt-20 md:pt-36 lg:pt-52">
            <div className="basis-full text-center ">
              <h1 className="monofont text-5xl">Why LOF?</h1>
            </div>
          </div>
        </div>
        ...
        <div className=" container-fluid scrollwhylof ">
          <div className="flex flex-col md:flex-row text-white my-2 md:my-10  gap-2 md:gap-10 lg:gap-10 lg:px-10">
            <div className="basis-2/4 py-4  px-4 md:py-8  md:px-8 card-bg">
              <div className="flex pb-3">
                <Image src={Money} width={60} height={60}  alt="Picture of the author" />
                <h6 className="my-auto hind text-xl font-bold " style={{ paddingLeft: "2rem" }}>
                  More Profit
                </h6>
              </div>
            ...
            <div className="basis-2/4 py-4  px-4 md:py-8  md:px-8 card-bg">
              <div className="flex pb-3">
                <Image src={Inlove} width={60} height={60}  alt="Picture of the author" />
                <h6 className="my-auto hind text-xl font-bold" style={{ paddingLeft: "2rem" }}>
                  More Features
                </h6>
              </div>
          ...
          <div className="flex flex-col md:flex-row text-white gap-2 md:gap-10 lg:gap-10 lg:px-10  ">
            <div className="basis-2/4 py-4  px-4 md:py-8  md:px-8 card-bg">
              <div className="flex pb-3">
                <Image src={followers} width={60} height={60}  alt="Picture of the author" />
                <h6 className="my-auto hind text-xl font-bold"  style={{ paddingLeft: "2rem" }}>
            ...
            <div className="basis-2/4 py-4 px-3 md:py-8  md:px-8 card-bg">
              <div className="flex pb-3">
                <Image src={collaboration} width={60} height={60}   alt="Picture of the author" />
                <h6 className="my-auto hind text-xl font-bold" style={{ paddingLeft: "2rem" }}>
                  More Freedom
                </h6>
              </div>
