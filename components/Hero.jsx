      ...
      <div className="bg-dark hero " id="Home">
        <div className="container-fluid ">
          <div className="flex flex-col pt-5 text-white lg:flex-row lg:pt-28">
            <div
              className="basis-1/5 md:basis-1/3 pt-40 pl-0 md:pt-32 lg:pt-60 md:pl-10 stroke-[2px] mbl-resp-hero "
              data-aos="fade-right"
            >
              <h1 className="text-[4.7rem] md:text-[7.7rem] font-black pop main-heading flex lg:justify-start leading-[8rem]">
                LONELY
              </h1>
            ...
            >
              ...
              <p className="flex leading-8  text-xs md:leading-8 md:tracking-wider home-txt md:text-base lg:justify-start">
