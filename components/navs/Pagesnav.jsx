            ...
            <>
              <div className=" mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex items-center  h-16 for-nav ">
                  ...
                  <div className="hidden md:block basis-2/5 text-white">
...
<button className="button button--moema font-medium button--text-upper text-xs rounded-md px-5 py-2">Sign in</button>
              ...
              <Disclosure.Panel className="md:hidden">
                ...
                <div className="pt-4 pb-3 border-t border-gray-700 text-white">
